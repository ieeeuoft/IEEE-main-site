...
export default function OldTeam() {
    return (
        <Accordion className={styles['accordion']} allowZeroExpanded={true} allowMultipleExpanded={true}>
            ...
            <AccordionItem className={styles['accordion__item']}>
                ...
                <ul>
                    ...
                    <li>Chair of Women In Engineering and Power/Energy Chapter: Yoley Li</li>
                ...
                <p><strong>Computer/Electronics Technical Chapter:</strong></p>
                <ul>
                ...
                <ul>
                    <li>Chair of Finance: Peter Nearing</li>
                    <li>Director of Finance and External Sponsorship: David Wang</li>
                    <li>Director of Finance and Internal Sponsorship: Piyush Gupta</li>
                    <li>Director of Finance and Membership Benefits: Grace Tian</li>
                    <li>Committee Advisor: Michael Chai</li>
                </ul>
                
                <p><strong>IEEE Toronto Section Website Revamp Project:</strong></p>
                <ul>
            ...
            <AccordionItem className={styles['accordion__item']}>
                ...
                <ul>
                    ...
                    <li>Vice Chair Professional Development: Shahed Mirmohammadi</li>
            ...
            <AccordionItem className={styles['accordion__item']}>
                ...
                <ul>
                    ...
                    <li>Vice Chair Professional Development: Haoxiao (Cathy) Wang</li>
